				...
				<div id="div2" class="form-group">
					...
					<div id="pic">
						...
						<%-- <!--  描述一： -->
							...
							<div id="pic1">
								<img
									src="${pageContext.request.contextPath}/images/travel/1.jpg" />
							</div>
						<!--   描述二： --><div id="describle2"><input type="file" name="file" id="doc1"></div>
						   <div id="pic2">
						     <img src="${pageContext.request.contextPath}/images/travel/1.jpg"/>
						  </div>
						  <!-- 描述三： --><div id="describle3"><input type="file" name="file" id="doc1"></div>
						   <div id="pic3">
						     <img src="${pageContext.request.contextPath}/images/travel/1.jpg"/>
						  </div> --%>
					</div>
